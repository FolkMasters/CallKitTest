...
/*!
 ...
 RongRTCLib version: 4.0.4
 RongRTCLib commit: aae5735
 RongRTCLib time: 202011121936
 */
...
/**
 音效管理器，通过调用 `RCRTCAudioEffectManager.h` 中的 API 实现所有音效功能。
 */
...
- (void)leaveRoom:(nonnull NSString *)roomId
       completion:(nonnull void (^) (BOOL isSuccess, RCRTCCode code))completion;
