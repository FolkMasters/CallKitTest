...
//  CallKitDemo
//
//  Created by Zafer.Lee on 2020/12/21.
...
@interface RTCViewController ()<RCRTCRoomEventDelegate>
...
- (void)initializeRCIMClient{
    ...
    //前置条件 IM建立连接
    [[RCIMClient sharedRCIMClient] connectWithToken:@"LasbGC4jLW94lD2PA0rEWYa9SsbEb6gR/erDkZ3DP70=@rf59.cn.rongnav.com;rf59.cn.rongcfg.com" dbOpened:^(RCDBErrorCode code) {} success:^(NSString *userId) {
...
- (void)exitRoom{
    ...
    //退出房间
    [self.engine leaveRoom:RoomId completion:^(BOOL isSuccess, RCRTCCode code) {
